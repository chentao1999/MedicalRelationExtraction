...
class TextConfig():
    ...
    output_dir = './result'
    data_dir = './corpus/TCM/'  # the path of input_data file
    training_data = data_dir + 'HD_fold5_training.txt'
    dev_data = data_dir + 'HD_fold5_test.txt'
    test_data = data_dir + 'HD_fold5_test.txt'

    BERT_BASE_DIR = './pretrained_bert_model/chinese_L-12_H-768_A-12/'
...
def train():
    ...
    tensorboard_dir = os.path.join(config.output_dir, "tensorboard/TCM")
    save_dir = os.path.join(config.output_dir, "checkpoints/TCM")
